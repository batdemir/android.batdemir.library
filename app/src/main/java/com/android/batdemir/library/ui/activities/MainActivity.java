...
import com.android.batdemir.library.ui.activities.base.BaseActivity;
...
public class MainActivity extends BaseActivity implements
    ...
    public void setListeners() {
        binding.btnNextPage.setOnClickListener(v -> Tool.getInstance(context).move(ScrollingActivity.class, true, false, null));
